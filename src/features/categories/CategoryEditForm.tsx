    ...
    <div className="rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="mt-5 flex flex-col gap-4 border-b border-slate-200 pb-5 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            ...
            <span className={draft.isVisible ? "inline-flex items-center gap-1 rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-900" : "inline-flex items-center gap-1 rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-500"}>
      ...
      <div className="mt-8 flex flex-wrap justify-end gap-3">
        ...
        <button
          type="button"
          onClick={onSave}
          className="inline-flex items-center gap-2 rounded-2xl bg-blue-900 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-blue-950"
        >
